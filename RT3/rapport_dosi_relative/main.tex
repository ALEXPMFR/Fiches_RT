...
\begin{figure}[h] 
  \centering
  \includegraphics[scale=0.4]{figures/tpr_schema.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.4]{figures/rtm_schema.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.45]{../scripts/figures/dose_relative/chambre_ref.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.4]{../scripts/figures/dose_relative/perturbations_chambre/perturbations_X6.png}

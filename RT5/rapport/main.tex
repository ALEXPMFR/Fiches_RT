...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.6]{figures/foc_films.PNG}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.45]{figures/3x3_comp.PNG}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.5]{figures/10x10_comp.PNG}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.5]{figures/FOC_comp.PNG}

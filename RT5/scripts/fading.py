...
for t in time:
    ...
    for tiff in tiff_files:
        img_arr0 = sitk.GetArrayFromImage(sitk.ReadImage(str(tiff_files[0])))[520:600, 400:475].mean()
        img_arr1 = sitk.GetArrayFromImage(sitk.ReadImage(str(tiff_files[1])))[520:600, 400:475].mean()
        img_arr2 = sitk.GetArrayFromImage(sitk.ReadImage(str(tiff_files[2])))[520:600, 400:475].mean()
